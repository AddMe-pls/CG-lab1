...
//___________________Functions_______________________________________________
...
//______________________________Process__________________________________________

//..........PointFilter____________________________________________________
...
//........MatrixFilter______________________________________________________
...
//____________________calcNewPixelColor___________________________________________

//..........PointFilter_______________________________________________________
...
QColor BrightUp::calcNewPixelColor(const QImage& img, int x, int y) const
{
	QColor color = img.pixelColor(x, y);
...
{
	QColor color;
		color = img.pixelColor(clamp(x + (RandDouble(0, 1) - 0.5) * 10, double(img.width() - 1), 0.0), clamp(y + (RandDouble(0, 1) - 0.5) * 10, double(img.height() - 1), 0.0));
	return color;
}

//..........MatrixFilter________________________________________________________________________
