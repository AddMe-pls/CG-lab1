...
{
public:
	SobelFilterX() : MatrixFilter(SobelKernelX()) {}
};

class SobelFilterY : public MatrixFilter
{
public:
	SobelFilterY() : MatrixFilter(SobelKernelY()) {}
};

class SharpnessUp : public MatrixFilter
{
public:
	SharpnessUp() : MatrixFilter(SharpnessUpKernel()) {}
};
